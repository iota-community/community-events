...
6. Staking Analyse: [iotatools.dev/#/staking-rewards...](https://iotatools.dev/#/staking-rewards?network=mainnet)
7. Staking Analyse: [iotastaking.com](https://www.iotastaking.com)
...
7. Token Launchpad: [https://tokenlabs.network/forge](https://tokenlabs.network/forge)
...
10. Staking Explorer: [dlt.green/de/services/staking-explorer](https://dlt.green/de/services/staking-explorer)
11. First Game: [iotaflip.netlify.app](https://iotaflip.netlify.app/)
12. Raffles or Giveaways: [iota-raffle.netlify.app](https://iota-raffle.netlify.app/); [Thread](https://x.com/teunvw5/status/1917567987273421140)
13. IOTA Giveaways: [https://iota.gives/](https://iota.gives/)
14. Link your EVM address to your MoveVM account: [iotalink.io](https://iotalink.io/)
15. Globaler Messanger: [my2c.eu](https://my2c.eu/) (funktioniert schon im Testnetz)
16. Digitale (Objekt) ID: [X-Account: ObjectID_io](https://x.com/ObjectID_io); Website: [https://objectid.io/](https://objectid.io/)
17. Digitale Identität Portfolio Manager: [liquidlink.io](https://liquidlink.io/)
18. Einfache Coin Giveaways: [iota.gives](https://iota.gives/)
19. Spamer auf IOTA Rebased: [iotaspam.io](https://iotaspam.io/)
20. IOTA NFT: [apedao.io](https://apedao.io/)
21. IOTA Referalprogram: [iota.liquidlink.io](https://iota.liquidlink.io/profile)
22. Loyalty Program: [GiveReps](https://giverep.com/)
...
2. [IOTA Product Swuite](https://www.iota.org/products/product-suite)
3. [iotalabs.io](https://iotalabs.io/)
4. [Create IOTA App CLI](https://create-iota-app.vercel.app/) from [NakamaLabs](https://x.com/Nakama_Labs)
...
12. TWIN Tutorial: [#2 TWIN Technical Webinar, 24 September 2025](https://www.youtube.com/watch?v=i-KkG9NsHJg)
13. Goldsky.io Tutorial [Indexing IOTA with Subgraphs and Mirror Pipelines](https://www.youtube.com/watch?v=OESdnAg5Xk0&list=PLMbc46iGTB_Samx211B0e5ulm420tljN2)
14. [IOTA Trust Framework](https://www.iota.org/learn/trust-framework?ref=blog.iota.org); [Blogpost dazu](https://blog.iota.org/iota-trust-framework/); [Thread von der IF dazu](https://x.com/iota/status/1975546655748378859); Demo dazu: [demo.iota.org](http://demo.iota.org/)
